...
function Login() {
  ...
  const addElement = () => {
    ...
    const newElement = <h1 key={counter} className="text-3xl">I hope you crash head first into a bus full of retarded children</h1>;
    setRetard(prevElements => [...prevElements, newElement]);
  };
